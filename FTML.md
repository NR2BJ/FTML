...
- [ ] 챕터 지원 — MKV 내장 챕터 읽기 + 수동 마커
- [ ] A-B 구간 반복
- [ ] PiP (Picture-in-Picture)
- [ ] 스크린샷 캡처 — 현재 프레임 PNG 저장
- [ ] 제스처 컨트롤 — 모바일 스와이프 (시크/볼륨)
- [ ] 오프닝/엔딩 스킵 — 수동 마킹 기반
- [ ] 북마크/타임스탬프 메모
- [ ] 외부 플레이어 연동 — mpv:// 프로토콜
- [ ] 호버 프리뷰 — 썸네일 스냅샷 슬라이드
...
- [ ] OpenAI Whisper API — 구현 완료, 실환경 테스트 필요
- [ ] faster-whisper CUDA — NVIDIA GPU Docker 테스트
- [ ] DeepL 번역 — 번역 품질 테스트
- [ ] AMD ROCm/VAAPI — AMD GPU 환경 테스트
- [ ] NVIDIA NVENC — 트랜스코딩 파이프라인 검증
